...
**Covers:** Uplay R1 (AC2, Far Cry 3 era), Uplay R2 (Valhalla, newer titles), Ubisoft Connect (UPC), Orbit (Driver: SF).
...
Output DLLs appear under `Build/Bin/{R1,R2,UPC,Orbit}/`.
